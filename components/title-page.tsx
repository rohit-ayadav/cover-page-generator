...
export default function TitlePage({ data }: TitlePageProps) {
  ...
  return (
    <div className="relative w-full bg-gray-100 rounded-lg overflow-hidden">
      ...
      <div className="w-full overflow-auto bg-gray-100 p-4 md:p-8 min-h-[calc(100vh-20rem)]">
        {/* A4 Page with preserved aspect ratio */}
        <div className="w-[210mm] mx-auto bg-gray-300 shadow-lg" style={{ height: '297mm' }}>
          {/* Actual Content Card */}
          <Card 
